<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <ul aria-expanded="false">
                ...
                <li><a href="{{route('Course.create')}}">Thêm Khóa Học</a></li>
                    <li><a href="{{route('Course.index')}}">Danh Sách Khóa Học</a></li>
    ...
    <ul aria-expanded="false">
        ...
        <div class="copyright">
            <p><strong> Nguyễn Thị Thuận</strong> © 2022 </p>
            <p class="fs-12"> Nguyễn Thị Thuận <span class="heart"></span> Nguyễn Thị Thuận</p>
        </div>
    </div>
</div>