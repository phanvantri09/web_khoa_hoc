                    ...
                    <div class="card-body">
                        ...
                        <div class="email-box ms-0 ms-sm-0 ms-sm-0">
                            ...
                            <div class="basic-form">
                                ...
                                <form action="{{route('Course.update', $pro->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="compose-content">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="name" value="{{$pro ->name}}" name="name" class="form-control" placeholder="name">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-file">
                                                    <input type="file" value="{{$pro ->image}}" name="image" class="form-file-input form-control">
